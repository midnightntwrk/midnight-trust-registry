...
import { exampleEcJsonWebKey, exampleJsonWebKey, exampleP256JsonWebKey, exampleRelativeVerificationMethodInput, exampleVerificationMethodInput, } from "./fixtures/did";
describe("createVerificationMethod", () => {
    ...
    it("rejects OKP keys that include a y coordinate", () => {
        expect(() => createVerificationMethod({
...
//# sourceMappingURL=did-document.verification-method.test.js.map