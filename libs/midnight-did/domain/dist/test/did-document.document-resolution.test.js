...
import { createDIDDocument, createService, createVerificationMethod, parseDIDResolutionResult, parseDIDURL, } from "../did-document";
import { exampleDid, exampleEcJsonWebKey, examplePathServiceInput, exampleRelativeServiceInput, exampleResolutionPayload, exampleSegmentServiceInput, exampleServiceInput, exampleServiceObjectInput, exampleServiceSet, exampleVerificationMethodInput, } from "./fixtures/did";
...
describe("DID resolution payloads", () => {
    it("parses valid DIDResolutionResult", () => {
        ...
        expect(payload.didResolutionMetadata.contentType).toBe(exampleResolutionPayload.didResolutionMetadata.contentType);
    });
});
