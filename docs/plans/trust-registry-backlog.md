...
| TR-027 | P2 | In progress on `codex/trust-registry-api-query-surface` | Add applicant and query REST API. | Applicants can submit applications and consumers can query trust/evidence through stable HTTP endpoints. |
