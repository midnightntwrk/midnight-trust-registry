...
| TR-025 | P1 | Current branch `codex/trust-registry-governance-policy-bindings` | Add governance policy templates and bindings. | Maintainer, member, emergency, and auditor decisions can bind to typed policy templates and fixtures. |
